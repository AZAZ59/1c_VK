...
from utils import VK_Item, merge_excel, art_split_markers, split_marker, delete_all_files
...
def process_to_1c(df, save_dir, name, name_album):
    ...
    with open(f'./errors/Дубли_в_Альбомах.txt', 'a', encoding='utf-8') as f:
        f.write(duplicated.to_csv(None, sep=';'))
